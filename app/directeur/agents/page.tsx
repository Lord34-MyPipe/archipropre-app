...
export default async function DirecteurAgents() {
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      <div className="bg-[#0A2E5A] text-white px-6 py-6 md:px-8">
        <h1 className="text-2xl font-bold">Tous les agents</h1>
        <p className="text-blue-300 text-sm mt-0.5">{agentsWithStats.length} agent(s) — toutes équipes</p>
      </div>
