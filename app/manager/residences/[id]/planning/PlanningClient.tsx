      ...
      <div className="bg-[#0A2E5A] text-white px-6 py-5 md:px-8">
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            ...
            className="shrink-0 flex items-center gap-2 px-4 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-white text-sm font-semibold transition-colors border border-white/20 disabled:opacity-40 disabled:cursor-not-allowed disabled:pointer-events-none">
        ...
        {!residenceActif && (
          <div className="flex items-center gap-3 px-4 py-3 rounded-xl border" style={{ background: '#FEF9F0', borderColor: '#F5A623' }}>
            ...
            <p className="text-sm font-medium" style={{ color: '#92600A' }}>
              Résidence en sommeil — le planning est en lecture seule. Réactivez la résidence via le Contrat pour régénérer.
            </p>
          </div>
        )}
